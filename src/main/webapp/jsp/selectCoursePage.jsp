...
<script type="text/javascript">
	$(function () {
		if(${openFlag == "false"}){
            layer.alert('现在不是选课时间!!', {icon: 6});
		}
    })
    function choose(pdata){
        layer.confirm('确定要选这门课吗？', {
            btn: ['确认','取消'] //按钮
        }, function(){
            window.location.href = "getSelectCoursePage?page=1&content&courseId=" + pdata;
        });
    }
...
<section class="layui-larry-box">
	...
	<blockquote class="layui-elem-quote news_search">
		...
		<form action="getSelectCoursePage" method="post">
			...
			<div class="layui-inline">
				...
				<a href="getChoosePage?page=1&content=&courseId=0" class="layui-btn layui-btn-normal newsAdd_btn">查看已选课程</a>
			<div class="layui-inline">
                ...
                <div class="layui-form news_list">
					...
					<tbody class="news_content">
						...
						<tr>
							...
							<td>
								<a onclick="choose(${list.id})" class="layui-btn layui-btn-mini news_edit"><i class="iconfont icon-edit"></i> 选课</a>
		...
		<form name="form1" method="post" action="getSelectCoursePage">
